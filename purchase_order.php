                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <table id="example1" class="table table-bordered">
                                    ...
                                    <tbody>
                                        <?php
                                          $sql = "SELECT *,purchase_order_id FROM purchase_order LEFT JOIN supplier ON supplier.id =purchase_order.id LEFT JOIN supplier_product on supplier_product.supplier_product_id=purchase_order.id";
