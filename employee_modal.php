            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="employee_add.php" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" id="addressInfo" name="address"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="contactInfo" name="contact">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" id="genderSelection" name="gender" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" name="department" id="departmentSelection" required>
                                <option value="" selected>- Select -</option>
                                <?php
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" name="job" id="jobSelection" required>
                                <option value="" selected>- Select -</option>
                                <?php
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" id="scheduleSelection" name="schedule" required>
                                <option value="" selected>- Select -</option>
                                <?php
                                  $sql = "SELECT time_in, time_out FROM schedules";
                                  $query = $conn->query($sql);
